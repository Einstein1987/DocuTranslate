...
// ============================================================
//
// 1. Copiez ce fichier dans votre dossier functions/
//    → functions/translate-libre.js
//
// 2. Mettez à jour docutranslate.js :
//    Changez l'URL de :
//      '/.netlify/functions/translate'
//    vers :
//      '/.netlify/functions/translate-libre'
//
// 3. Déployez sur Netlify :
//    $ git add .
//    $ git commit -m "Migration vers LibreTranslate"
//    $ git push
//
// 4. C'est tout ! Aucune clé API nécessaire ✅
//
// ============================================================
// AUTO-HÉBERGEMENT (OPTIONNEL)
// ============================================================
//
// Pour héberger votre propre instance LibreTranslate :
//
// Option 1 - Docker (sur serveur du collège) :
// $ docker run -ti --rm -p 5000:5000 libretranslate/libretranslate
//
// Option 2 - Railway.app (gratuit) :
// 1. Créez un compte sur railway.app
// 2. Déployez depuis GitHub : github.com/LibreTranslate/LibreTranslate
// 3. Ajoutez l'URL dans CONFIG.LIBRE_TRANSLATE_APIS
//
